...
class LoraPacePolicyTest {
    ...
    /**
     * The queue has three structural writers on three coroutines and [java.util.ArrayDeque] is not
     * thread-safe: a change under `admitBest`'s index walk nulls the slot it is about to read.
     * Field-observed on the lab P7 (2026-09-10) as `NullPointerException: … OutboundFrame.getBucket()`,
     * which kills the pacer loop and silences the plane until the app restarts.
     *
