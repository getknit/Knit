 ...
 * the pacer books and asks, and [LoraFrameCodec] prices a packet on whichever coroutine is sending — and
 * `admits` prunes, so asking mutates too. The monitor is taken **inside** [LoraPacePolicy]'s and never the
 * other way round, which is the whole lock order there is.
 *
